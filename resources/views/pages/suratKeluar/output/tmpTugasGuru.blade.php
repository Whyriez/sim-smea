...
<body class="mx-10">
    ...
    <div style="text-align: center; margin-top: 1rem; margin-bottom: 1rem;">
        <h2 style="font-weight: 700; text-decoration: underline; margin:0px">SURAT TUGAS</h2>
    ...
    <div class="ml-14" style="margin-top: 1rem; margin-bottom:1rem">
        <p><span style="display: inline-block; width: 100px">Nama </span>: <strong>{{ $nama_diterangkan }}</strong></p>
        <p><span style="display: inline-block; width: 100px">Nip </span>: {{ $nip_diterangkan }}</p>
        <p><span style="display: inline-block; width: 100px">Pangkat.Gol </span>: {{ $pangkat_gol }}</p>
        <p><span style="display: inline-block; width: 100px">Jabatan </span>: {{ $pangkat_gol }}</p>
    </div>
    @php
