...
<body class="mx-10 font-tmr">
    ...
    <h1 style="text-decoration: underline;" class="text-center font-black underline mt-4">SURAT DISPENSASI</h1>
    <p class="text-center">Nomor : {{ $nomor_surat }}</p>
    <p style="text-align: justify" class="mt-8">{{ $perihal }}</p>
    <table class="border  border-collapse table-auto mx-auto w-full my-4">
        <thead>
            <tr>
                <th style="border-color: black" class="border">No.</th>
                <th style="border-color: black" class="border">NAMA</th>
                <th style="border-color: black" class="border">KELAS</th>
