@extends('layouts.app')
@section('title', 'Surat Keluar Tugas Siswa')
@section('tugas-siswa', 'bg-gray-300 dark:bg-gray-700')
...
@section('content')
    <div
        ...
        <div class="w-full mb-1">
            ...
            @endif
            <div class="mb-4">
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Surat Tugas Siswa</h1>
            </div>
            <div class="sm:flex">
                <div class="items-center hidden mb-3 sm:flex sm:divide-x sm:divide-gray-100 sm:mb-0 dark:divide-gray-700">
                    <form class="lg:pr-3" action="{{ url('surat-keluar-tugas-siswa') }}" method="GET">
        ...
        <div class="relative w-full h-full max-w-[80rem] px-4 md:h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                ...
                <div class="p-6 space-y-6">
                    <form action="{{ url('store-surat-keluar-tugas-siswa') }}" method="post"
                        ...
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <textarea name="perihalAwal"
                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    id="perihalAwal" cols="10" rows="3" required>Kepala SMK Negeri 1 Gorontalo memberikan tugas kepada :</textarea>
                            </div>
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <textarea name="kegiatan"
                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    id="kegiatan" cols="10" rows="3" required>Untuk mengikuti kegiatan "TRY OUT: yang dilaksanakan terhitung mulai tanggal 23 Oktober s.d 25 Oktober 2023 di Kota Manado Provinsi Sulawesi Utara.</textarea>
                            </div>
                            {{-- <div class="col-span-6 sm:col-span-3">
