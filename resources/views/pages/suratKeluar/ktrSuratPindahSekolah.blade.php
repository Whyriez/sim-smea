...
@section('keterangan-pindah', 'bg-gray-300 dark:bg-gray-700')
@section('activeSuket', '')
...
@section('content')
    <div
        ...
        <div class="w-full mb-1">
            ...
            @endif
            <div class="mb-4">
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Surat Pindah Sekolah
                </h1>
            </div>
            <div class="sm:flex">
                <div class="items-center hidden mb-3 sm:flex sm:divide-x sm:divide-gray-100 sm:mb-0 dark:divide-gray-700">
                    <form class="lg:pr-3" action="{{ url('surat-keluar-keterangan-pindah') }}" method="GET">
        ...
        <div class="relative w-full h-full max-w-[80rem] px-4 md:h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                ...
                <div class="p-6 space-y-6">
                    <form action="{{ url('store-surat-keluar-keterangan-pindah') }}" method="post"
                        ...
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6 sm:col-span-8">
                                ...
                                <div>
                                    <div class="sm:flex justify-stretch gap-4">
                                        ...
                                        <div class="w-full">
                                            <label for="jns_klm_bertanda"
                                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Jenis
                                                Kelamin</label>
                                            <input type="text" name="jns_klm_bertanda" id="jns_klm_bertanda"
                                                class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                                placeholder="Kelas" required>
                                        </div>
                                        <div class="w-full">
                                            <label for="kelas_bertanda"
                                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kelas</label>
                                            <input type="text" name="kelas_bertanda" id="kelas_bertanda"
                                                class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                                placeholder="Kelas" required>
                                        </div>
                                        <div class="w-full">
                                            <label for="jrs_bertanda"
                                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Program
                                                Keahlian</label>
                                            <input type="text" name="jrs_bertanda" id="jrs_bertanda"
                                                class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            ...
                            <div class="col-span-6 sm:col-span-8">
                                <hr class="h-px my-3 bg-gray-200 border-0 dark:bg-gray-700">
                                <div class="flex justify-between">
                                    <h4 class="text-2xl font-bold dark:text-white">Sesuai permohonan pindah sekolah oleh
                                        orang tua siswa/wali :</h4>
                                </div>
                                <hr class="h-px my-2 bg-gray-200 border-0 dark:bg-gray-700">
                                <div>
                                    <div class="sm:flex justify-stretch gap-4">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                <label for="perihalSurat"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Perihal</label>
                                <input type="text" name="perihalSurat" id="perihalSurat"
                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    value="Telah mengajukan pindah sekolah ke ..., dengan alasan permintaan orang tua"
                                    required>
                            </div>
