@extends('layouts.app')
@section('title', 'Surat Keluar Lolos Butuh Guru')
@section('keterangan-llsbth-guru', 'bg-gray-300 dark:bg-gray-700')
        ...
        <div class="w-full mb-1">
            ...
            <div class="sm:flex">
                <div class="items-center hidden mb-3 sm:flex sm:divide-x sm:divide-gray-100 sm:mb-0 dark:divide-gray-700">
                    <form class="lg:pr-3" action="{{ url('surat-keluar-keterangan-lolos-butuh-guru') }}" method="GET">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                ...
                <div class="flex items-start justify-between p-5 border-b rounded-t dark:border-gray-700">
                    <h3 class="text-xl font-semibold dark:text-white">
                        Tambah Surat Keterangan Lolos Butuh Guru
                    </h3>
                ...
                <div class="p-6 space-y-6">
                    <form action="{{ url('store-surat-keluar-keterangan-lolos-butuh-guru') }}" method="post"
                        ...
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <input type="hidden" name="tipeSurat" id="tipeSurat"
                                class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                value="Lolos Butuh Guru" required>
                            <div class="col-span-6 sm:col-span-3">
                                <label for="perihal"
                        ...
                        <h4 class="text-2xl font-bold dark:text-white">Surat Keterangan Lolos Butuh Guru</h4>
                        <hr class="h-px my-2 bg-gray-200 border-0 dark:bg-gray-700">
                        <div class="grid grid-cols-6 gap-6">
                            <div class="col-span-6 sm:col-span-3">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <textarea name="perihalSurat"
                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    id="perihalSurat" cols="10" rows="3" required>Sesuai dengan displin ilmu yang dimiliki bersangkutan pada dasarnya dapat diterima di SMK Negeri 1 Gorontalo dengan alasan kurangnya Guru Matematika</textarea>
                            </div>
                        </div>
                </div>
                <!-- Modal footer -->
