...
<body class="mx-10 mt-4">
    ...
    <div style="text-align: center; margin-top: 1rem; margin-bottom: 2.5rem">
        <h2 style="font-weight: 700; text-decoration: underline">
            SURAT PERTANGGUNG JAWABAN GURU MUTLAK
        </h2>
    ...
    <div style="margin-bottom: 1.25rem;">
        ...
        <div style="text-align: justify; margin-left: 3rem">
            <p>
                <span style="display: inline-block; width: 160px">Nama </span>:
                {{ $nama_bertanda }}
            </p>
            <p>
                <span style="display: inline-block; width: 160px">Tempat/tanggal lahir </span>:
                {{ $tmp_tgl_lahir_bertanda }}
            </p>
            <p>
                <span style="display: inline-block; width: 160px">pekerjaan </span>:
                {{ $pekerjaan }}
            </p>
            <p>
                <span style="display: inline-block; width: 160px">NIP </span>:
                {{ $nip_bertanda }}
            </p>
            <p>
                <span style="display: inline-block; width: 160px">Pangkat </span>:
                {{ $pangkat_golongan }}
            </p>
            <p>
                <span style="display: inline-block; width: 160px">Jabatan </span>:
                {{ $jabatan_bertanda }}
            </p>
            <p>
                <span style="display: inline-block; width: 160px">Unit Kerja </span>:
                {{ $unit_kerja }}
            </p>
        </div>
    </div>
    <div style="margin-bottom: 1.25rem">
        ...
        <div style="text-align: justify; margin-left: 3rem">
            ...
            <p>
                <span style="display: inline-block; width: 160px">Tempat Tanggal lahir </span>:
                {{ $tmp_tgl_lahir_diterangkan }}
            </p>
            <p>
                <span style="display: inline-block; width: 160px">Alamat </span>:
                {{ $alamat_diterangkan }}
            </p>
        </div>
    </div>
    <div style="margin-bottom: 4rem">
        ...
        <p style="text-align: justify; margin-bottom: 1.25rem">
            Demikian surat pernyataan ini saya buat dengan sebenar-benarnya dan bertanggung jawab mutlak dan hukum.
        </p>
    </div>
...
<body>
    <h1>Data Pertanggung Jawaban Multak Guru</h1>
    <p>Nomor Surat: {{ $nomor_surat }}</p>
    <p>Yang Bertanda tangan dibawah ini : </p>
    <p>Nama : {{ $nama_bertanda }}</p>
    <p>tmp_tgl_lahir_bertanda : {{ $tmp_tgl_lahir_bertanda }}</p>
    <p>pekerjaan : {{ $pekerjaan }}</p>
    <p>nip_bertanda : {{ $nip_bertanda }}</p>
    <p>pangkat_golongan : {{ $pangkat_golongan }}</p>
    <p>jabatan_bertanda : {{ $jabatan_bertanda }}</p>
    <p>unit_kerja : {{ $unit_kerja }}</p> <br>

    <p>Dengan ini menerangkan : </p>
    <p>Nama : {{ $nama_diterangkan }}</p>
    <p>tmp_tgl_lahir_diterangkan : {{ $tmp_tgl_lahir_diterangkan }}</p>
    <p>alamat_diterangkan : {{ $alamat_diterangkan }}</p>

    <p>Perihal: {{ $perihal }}</p>

    <p>nama_ttd: {{ $nama_ttd }}</p>
    <p>nip_penanda: {{ $nip_penanda }}</p>
</body>
