...
<body>
    ...
    <div style="text-align: center; margin-top: 1rem; margin-bottom: 2.5rem;">
        <h2 style="font-weight: 700; text-decoration: underline;">SURAT KETERANGAN PENDAMPINGAN</h2>
    ...
    <div style="margin-bottom: 4rem;">
        ...
        <ol style="margin-left: 1.3rem">
            @foreach ($list_perihal as $index => $list)
                <li type="1">{{ $list }}</li>
            @endforeach
        </ol>
        <p style="text-align: justify; margin-top: 0.75rem; margin-bottom: 1.25rem;">Demikian surat keterangan ini
            dibuat untuk digunakan sebagaimana mestinya.</p>
    </div>
