...
@section('dispensasi-siswa', 'bg-gray-100 dark:bg-gray-700')
        ...
        <div class="relative w-full h-full max-w-[80rem] px-4 md:h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                ...
                <div class="p-6 space-y-6">
                    <form action="{{ url('store-surat-keluar-dispensasi') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                <label for="date_perihal"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tanggal
                                    Perihal</label>
                                <input type="date" name="date_perihal" id="date_perihal"
                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="Tanggal Perihal" required>
                            </div>
                            <div class="col-span-6 sm:col-span-3">
                                <label for="nomor_perihal"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nomor
                                    Perihal</label>
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                <label for="waktu_dilaksanakan"
                                    ...
                                    Waktu Dilaksanakan</label>
                                <input type="text" name="waktu_dilaksanakan"
                                    class="shadow-sm flex-shrink-0 bg-gray-50 border w-full border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="Nama Hari"
                                    value="dilaksanakan pada hari Senin tanggal 01 Januari 202X pukul 00:00 Wita s.d selesai"
                                    required>
                            </div>
