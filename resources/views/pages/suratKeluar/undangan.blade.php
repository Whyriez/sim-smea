@extends('layouts.app')
@section('title', 'Surat Keluar Undangan')
@section('undangan', 'bg-gray-300 dark:bg-gray-700')
@section('activeSuket', '')
...
@section('content')
    <div
        ...
        <div class="w-full mb-1">
            ...
            @endif
            <div class="mb-4">
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Surat Undangan Siswa</h1>
            </div>
            <div class="sm:flex">
                <div class="items-center hidden mb-3 sm:flex sm:divide-x sm:divide-gray-100 sm:mb-0 dark:divide-gray-700">
                    <form class="lg:pr-3" action="{{ url('surat-keluar-undangan') }}" method="GET">
                                ...
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <td class="p-4 space-x-2 whitespace-nowrap text-center">
                                        <button type="button" data-modal-toggle="lihatBerkas{{ $m->id }}"
                                            ...
                                            <i class="fa-solid fa-eye mr-2"></i> Lihat Berkas
                                        </button>
        ...
        <div class="relative w-full h-full max-w-[80rem] px-4 md:h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                ...
                <div class="p-6 space-y-6">
                    <form action="{{ url('store-surat-keluar-undangan') }}" method="post"
                        ...
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="date" name="tglSuratKeluar" id="tglSuratKeluar"
                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="Tanggal Surat" min="{{ now()->format('Y-m-d') }}"
                            ...
                            <input type="hidden" name="tipeSurat" id="tipeSurat"
                                class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="Undangan" value="Undangan">
                            <div class="col-span-6 sm:col-span-3">
                                <label for="perihal"
                        ...
                        <h4 class="text-2xl font-bold dark:text-white">Surat Undangan</h4>
                        <hr class="h-px my-2 bg-gray-200 border-0 dark:bg-gray-700">
                        <div class="grid grid-cols-6 gap-6">
                            <div class="col-span-6 sm:col-span-3">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="text" name="hal" id="hal"
                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="Hal" value="Undangan">
                            </div>
                            <div class="col-span-6 sm:col-span-3">
                                <label for="nama_siswa"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Penerima
                                    Siswa</label>
                                <input type="text" name="nama_siswa" id="nama_siswa"
                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="Penerima Siswa">
                            </div>
                            <div class="col-span-6 sm:col-span-3">
                                <label for="tgl_dilaksanakan"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tanggal
                                    Dilaksanakan</label>
                                <input type="date" name="tgl_dilaksanakan" id="tgl_dilaksanakan"
                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="Tanggal Dilaksanakan" required>
                            </div>
                            <div class="col-span-6 sm:col-span-3">
                                <label for="waktu_dilaksanakan"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Waktu
                                    Dilaksanakan</label>
                                <input type="text" name="waktu_dilaksanakan" id="waktu_dilaksanakan"
                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    value="09:00 s.d selesai" required>
                            </div>
                            <div class="col-span-6 sm:col-span-3">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                <label for="nama_wali"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Wali
                                    Kelas</label>
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                <label for="nip_wali"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nip Wali
                                    Kelas</label>
                                <input type="text" name="nip_wali" id="nip_wali"
                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="Nip Wali Kelas" required>
                            </div>
                        </div>
                </div>
                <!-- Modal footer -->
        ...
        <div class="fixed left-0 right-0 z-50 items-center justify-center hidden overflow-x-hidden overflow-y-auto top-1 md:inset-0 h-modal sm:h-full"
            ...
            <div class="relative w-full h-full max-w-2xl px-4 md:h-full">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                    ...
                    <!-- Modal body -->
                    <div class="p-6 space-y-6">
                        <h4 class="text-2xl font-bold dark:text-white">Berkas Surat Masuk Keluar</h4>
                        <hr class="h-px my-2 bg-gray-200 border-0 dark:bg-gray-700">
