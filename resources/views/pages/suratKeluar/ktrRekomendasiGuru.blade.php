@extends('layouts.app')
@section('title', 'Surat Keluar Rekomendasi Guru')
@section('keterangan-rekomendasi-guru', 'bg-gray-300 dark:bg-gray-700')
...
@section('content')
    <div
        ...
        <div class="w-full mb-1">
            ...
            @endif
            <div class="mb-4">
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Surat Keterangan Rekomendasi
                    Guru
                </h1>
            </div>
            <div class="sm:flex">
                <div class="items-center hidden mb-3 sm:flex sm:divide-x sm:divide-gray-100 sm:mb-0 dark:divide-gray-700">
                    <form class="lg:pr-3" action="{{ url('surat-keluar-rekomendasi-guru') }}" method="GET">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                ...
                <div class="flex items-start justify-between p-5 border-b rounded-t dark:border-gray-700">
                    <h3 class="text-xl font-semibold dark:text-white">
                        Tambah Surat Keterangan Rekomendasi Guru
                    </h3>
                ...
                <div class="p-6 space-y-6">
                    <form action="{{ url('store-surat-keluar-rekomendasi-guru') }}" method="post"
                        ...
                        <h4 class="text-2xl font-bold dark:text-white">Surat Keterangan Rekomendasi Guru</h4>
                        <hr class="h-px my-2 bg-gray-200 border-0 dark:bg-gray-700">
                        <div class="grid grid-cols-6 gap-6">
                            <div class="col-span-6 sm:col-span-3">
                            ...
                            <div class="col-span-6 sm:col-span-8">
                                ...
                                <div>
                                    <div class="sm:flex justify-stretch gap-4">
                                        ...
                                        <div class="w-full">
                                            <label for="unitKerja_bertanda"
                                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Unit
                                                Kerja</label>
                                            <input type="text" name="unitKerja_bertanda" id="unitKerja_bertanda"
                                                class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            ...
                            <div class="col-span-6 sm:col-span-8">
                                ...
                                <div>
                                    <div class="sm:flex justify-stretch gap-4">
                                        ...
                                        <div class="w-full">
                                            <label for="pangkat_diterangkan"
                                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Pangkat/Golongan</label>
                                            <input type="text" name="pangkat_diterangkan" id="pangkat_diterangkan"
                                                class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                                placeholder="Pangkat/Golongan" required>
                                        </div>
                                        <div class="w-full">
                                        ...
                                        <div class="w-full">
                                            <label for="unitKerja_diterangkan"
                                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Unit
                                                Kerja</label>
                                            <input type="text" name="unitKerja_diterangkan" id="unitKerja_diterangkan"
                                                class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                                placeholder="Unit Kerja" required>
                                        </div>
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <textarea name="perihalSurat"
                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    id="perihalSurat" cols="10" rows="3" required>Bahwa yang bersangkutan benar-benar Guru Mapel/tendik Produktif Pemasaran di SMK Negeri 1 Gorontalo yang saat ini menggunakan cuti Tahunan selama 7 (tujuh) hari terhitung mulai tanggal 1 November s.d 09 November 2023</textarea>
                            </div>
                        </div>
                </div>
                <!-- Modal footer -->
