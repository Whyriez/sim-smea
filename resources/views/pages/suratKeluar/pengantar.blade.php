@extends('layouts.app')
@section('title', 'Surat Keluar Pengantar')
@section('pengantar', 'bg-gray-300 dark:bg-gray-700')
@section('activeSuket', '')
...
@section('content')
    <div
        ...
        <div class="w-full mb-1">
            ...
            @endif
            <div class="mb-4">
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Surat Pengantar</h1>
            </div>
            <div class="sm:flex">
                <div class="items-center hidden mb-3 sm:flex sm:divide-x sm:divide-gray-100 sm:mb-0 dark:divide-gray-700">
                    <form class="lg:pr-3" action="{{ url('surat-keluar-pengantar') }}" method="GET">
        ...
        <div class="relative w-full h-full max-w-[80rem] px-4 md:h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                ...
                <div class="p-6 space-y-6">
                    <form action="{{ url('store-surat-keluar-pengantar') }}" method="post"
                        ...
                        <h4 class="text-2xl font-bold dark:text-white">Surat Pengantar</h4>
                        <hr class="h-px my-2 bg-gray-200 border-0 dark:bg-gray-700">
                        <div class="grid grid-cols-6 gap-6">
                            <div class="col-span-6 sm:col-span-3">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                <label for="kepada_yth"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kepada Yth</label>
                                <input type="text" name="kepada_yth" id="kepada_yth"
                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="Kepada Yang Terhormat" required>
                            </div>
                            <div class="col-span-6 sm:col-span-3">
                                <label for="lokasi"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Di</label>
                            ...
                            <div class="col-span-6 sm:col-span-8">
                                ...
                                <div class="flex justify-between">
                                    <h4 class="text-2xl font-bold dark:text-white">Data Uraian</h4>
                                    <button id="tambahSiswaBtn" onclick="tambahInput()"
                                        ...
                                        type="button">Tambah Uraian</button>
                                </div>
                                <hr class="h-px my-2 bg-gray-200 border-0 dark:bg-gray-700">
                                <div id="Container">
                                    <div class="sm:flex justify-stretch gap-4" id="inputGroup1">
                                        ...
                                        <div class="w-full">
                                            <label for="banyaknya"
                                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Banyaknya</label>
                                            <input type="text" name="banyaknya[]"
                                                ...
                                                placeholder="Banyaknya Berkas" required>
                                        </div>
                                        <div class="w-full">
