@extends('layouts.app')
@section('title', 'Surat Keluar Tugas Guru')
@section('tugas-guru', 'bg-gray-300 dark:bg-gray-700')
...
@section('content')
    <div
        ...
        <div class="w-full mb-1">
            ...
            @endif
            <div class="mb-4">
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Surat Tugas Guru</h1>
            </div>
            <div class="sm:flex">
                <div class="items-center hidden mb-3 sm:flex sm:divide-x sm:divide-gray-100 sm:mb-0 dark:divide-gray-700">
                    <form class="lg:pr-3" action="{{ url('surat-keluar-tugas-guru') }}" method="GET">
        ...
        <div class="relative w-full h-full max-w-[80rem] px-4 md:h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                ...
                <div class="p-6 space-y-6">
                    <form action="{{ url('store-surat-keluar-tugas-guru') }}" method="post"
                        ...
                        <h4 class="text-2xl font-bold dark:text-white">Surat Tugas Guru</h4>
                        <hr class="h-px my-2 bg-gray-200 border-0 dark:bg-gray-700">
                        <div class="grid grid-cols-6 gap-6">
                            <div class="col-span-6 sm:col-span-3">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                <label for="perihal_awal"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Perihal
                                    Kegiatan</label>
                                <textarea name="perihal_awal"
                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    id="perihal_awal" cols="10" rows="3" required>Berdasarkan surat dari Forum Koordinasi Pencegehan Terrorisme (FKPT) Provinsi Gorontalo nomor : 115/UND/FKPT-GTLO/XI/2023 tanggal 06 November 2023 perihal Undangan, Maka Kepala SMK Negeri 1 Gorontalo menugaskan kepada :</textarea>
                            </div>

                            <div class="col-span-6 sm:col-span-8">
                                <hr class="h-px my-3 bg-gray-200 border-0 dark:bg-gray-700">
                                <div class="flex justify-between">
                                    <h4 class="text-2xl font-bold dark:text-white">kepala sekolah memberikan dispensasi
                                        kepada :</h4>
                                </div>
                                <hr class="h-px my-2 bg-gray-200 border-0 dark:bg-gray-700">
                                <div>
                                    <div class="sm:flex justify-stretch gap-4">
                                        ...
                                        <div class="w-full">
                                            <label for="pangkat_gol"
                                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Pangkat,
                                                Gol</label>
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <textarea name="kegiatan"
                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    id="kegiatan" cols="10" rows="3" required>Untuk mengikuti kegiatan "*Perempuan Teladan, Optimis dan Produktif (TOP) Cerdas Digital, Satukan Bangsa Dalam Pencegahan Radikalisme Dan Terorisme Melalui FKTP Gorontalo*" yang dilaksanakan pada hari rabu tanggal 08 November 2023 Pukul 07:30 Wita s.d selesai bertempat di Gedung LPM Kampus IAIAN Sultan Amai Gorontalo.</textarea>
                            </div>
                        </div>
                </div>
                <!-- Modal footer -->
