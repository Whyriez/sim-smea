...
@section('dispensasi-guru', 'bg-gray-300 dark:bg-gray-700')
...
@section('content')
    <div
        ...
        <div class="w-full mb-1">
            ...
            @endif
            <div class="mb-4">
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Surat Dispensasi Guru</h1>
            </div>
            <div class="sm:flex">
                <div class="items-center hidden mb-3 sm:flex sm:divide-x sm:divide-gray-100 sm:mb-0 dark:divide-gray-700">
                    <form class="lg:pr-3" action="{{ url('surat-keluar-dispensasi-guru') }}" method="GET">
        ...
        <div class="relative w-full h-full max-w-[80rem] px-4 md:h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                ...
                <div class="p-6 space-y-6">
                    <form action="{{ url('store-surat-keluar-dispensasi-guru') }}" method="post"
                        ...
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <input type="hidden" name="tipeSurat" id="tipeSurat"
                                class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="Dispensasi Guru" value="Dispensasi Guru">
                            <div class="col-span-6 sm:col-span-3">
                                <label for="perihal"
                        ...
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="text" name="pangkat_gol" id="pangkat_gol"
                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="Pangkat, Gol" required>
                            </div>
                            <div class="col-span-6 sm:col-span-3">
                                <label for="jabatan"
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <textarea name="perihalSurat"
                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    id="perihalSurat" cols="10" rows="3" required>Untuk mengikuti kegiatan pameran "*Trade Expo Indonesia (TEI) dan Pameran Pangan Nusantara di Tangerang Banten*" yang mengikut ertakan IKM/UKM binaan Dinas Kumperindog Provinsi Gorontalo, yang dilaksanakan terhitung mulai hari selasa s.d Minggu tanggal 17 s.d 22 Oktober 2023 bertempat di ICE BSC Tangerang Banten .</textarea>
                            </div>
                        </div>
                </div>
                <!-- Modal footer -->
