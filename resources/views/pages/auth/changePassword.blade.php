...
@section('content')
    <div class="w-full bg-white dark:bg-gray-900 rounded-lg shadow-lg p-6">
        <h1 class="text-4xl mb-3 font-extrabold dark:text-white">
            Ubah Password</h1>
        ...
        @endif
        <form action="{{ url('proses-change-password') }}" method="POST">
            @csrf
            @method('put')
            <div class="mb-5">
            ...
            <div class="mb-5">
                <label for="confirmPassword" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Konfirmasi
                    Password</label>
